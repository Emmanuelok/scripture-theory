    ...
    <div className="space-y-8">
      <div className="rounded-2xl border border-ink-200 bg-white p-5 md:p-7 glow-ring">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-xs uppercase tracking-widest text-ink-400">Select a passage</span>
          <span className="ml-auto text-xs text-ink-400">
            {passages.length} curated · expanding to 50 in Q1
          </span>
        </div>
      ...
      <div className="rounded-2xl border border-ink-200 bg-white p-6 md:p-8 glow-ring">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3 text-sm">
          ...
          <InfoTile title="Christ-centered key" body={passage.christCentered} />
        </div>
      </div>

      <div className="rounded-2xl border border-ink-200 bg-ink-100/60 p-5 md:p-6">
        <div className="flex flex-wrap items-center gap-3">
          <span className="text-xs uppercase tracking-widest text-ink-500">Traditions</span>
          ...
          <span className="ml-auto text-xs text-ink-500">
            {enabled.size} of {allTraditionIds.length} lenses on
          </span>
        </div>
      </div>
        ...
        {passage.readings
          ...
          .map((r) => {
            ...
            return (
              <article
                key={r.tradition}
                className="rounded-2xl border border-ink-200 bg-white p-6 glow-ring"
              >
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-6">
          <div className="text-xs uppercase tracking-widest text-emerald-800">Where they agree</div>
          <p className="mt-2 text-emerald-950 leading-relaxed">{passage.agreement}</p>
        </div>
        <div className="rounded-2xl border border-amber-200 bg-amber-50/60 p-6">
          <div className="text-xs uppercase tracking-widest text-amber-800">Where they differ</div>
