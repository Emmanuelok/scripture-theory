...
export type AtlasPlace = {
  ...
  approx?: boolean;
  /** Show a permanent label at default zoom (vs. only on hover). */
  major?: boolean;
...
export const atlasRegions: AtlasRegion[] = [
  {
    ...
    places: [
      { name: "Eden (approximate)", short: "Eden", what: "The garden God planted for the first humans", ref: "Genesis 2:8", lat: 33.5, lon: 44.0, approx: true, major: true },
      { name: "Tigris & Euphrates", what: "The two surviving rivers of Eden's four", ref: "Genesis 2:14", lat: 33.0, lon: 43.5 },
      { name: "Ararat", what: "Where Noah's ark came to rest after the flood", ref: "Genesis 8:4", lat: 39.7, lon: 44.3, major: true },
      { name: "Babel (Babylon)", short: "Babel", what: "Where humanity's languages were divided", ref: "Genesis 11:9", lat: 32.54, lon: 44.42, major: true },
      { name: "Ur of the Chaldeans", short: "Ur", what: "Abraham's hometown — southern Mesopotamia", ref: "Genesis 11:31", lat: 30.96, lon: 46.10, major: true },
    ],
  },
  {
    id: "patriarchs",
    ...
    places: [
      { name: "Haran", what: "Where Abraham's family paused before entering Canaan", ref: "Genesis 12:4", lat: 36.86, lon: 39.03, major: true },
      ...
      { name: "Goshen (Egypt)", short: "Goshen", what: "Where Joseph settled his family during famine", ref: "Genesis 47:6", lat: 30.83, lon: 31.93, major: true },
    ],
  },
  {
    id: "exodus-wandering",
    ...
    places: [
      ...
      { name: "Mount Sinai (traditional Horeb)", short: "Mt Sinai", what: "The mountain of the giving of the Law", ref: "Exodus 19:18", lat: 28.54, lon: 33.97, approx: true, major: true },
  ...
  },
  {
    ...
    places: [
      { name: "Jericho", what: "First city to fall after the Jordan crossing", ref: "Joshua 6:20", lat: 31.87, lon: 35.44, major: true },
  ...
  },
  {
    ...
    places: [
      { name: "Bethlehem", what: "David's hometown; the prophet Samuel anointed him here", ref: "1 Samuel 16:1", lat: 31.70, lon: 35.20, major: true },
      { name: "Valley of Elah", what: "Where David killed Goliath", ref: "1 Samuel 17:2", lat: 31.69, lon: 34.95 },
      { name: "Hebron (David's first capital)", short: "Hebron", what: "Where David reigned seven years before Jerusalem", ref: "2 Samuel 5:5", lat: 31.535, lon: 35.105 },
      { name: "Jerusalem (City of David)", short: "Jerusalem", what: "Captured from the Jebusites; capital for the rest of Israel's history", ref: "2 Samuel 5:7", lat: 31.78, lon: 35.23, major: true },
  ...
  },
  {
    ...
    places: [
      { name: "Samaria", what: "Capital of the northern kingdom, built by Omri", ref: "1 Kings 16:24", lat: 32.28, lon: 35.19, major: true },
      { name: "Mount Carmel", what: "Where Elijah confronted the prophets of Baal", ref: "1 Kings 18:19", lat: 32.73, lon: 35.05 },
      { name: "Nineveh", what: "Capital of Assyria — Jonah's city", ref: "Jonah 1:2", lat: 36.36, lon: 43.16, major: true },
      { name: "Babylon", what: "Capital of the empire that took Judah into exile", ref: "2 Kings 25:1", lat: 32.54, lon: 44.42, major: true },
      { name: "Susa", what: "Persian capital where Esther served", ref: "Esther 1:2", lat: 32.19, lon: 48.26, major: true },
    ],
  },
  {
    id: "second-temple",
    ...
    places: [
      { name: "Bethlehem of Judea", short: "Bethlehem", what: "Where Christ was born — fulfilling Micah 5:2", ref: "Matthew 2:1", lat: 31.70, lon: 35.20, major: true },
      { name: "Nazareth", what: "Jesus' hometown in Galilee", ref: "Luke 2:39", lat: 32.70, lon: 35.30, major: true },
      { name: "The Jordan River", short: "Jordan R.", what: "Where John baptized Jesus", ref: "Matthew 3:13", lat: 32.31, lon: 35.57 },
      { name: "Capernaum", what: "Jesus' Galilean ministry base", ref: "Matthew 4:13", lat: 32.88, lon: 35.57, major: true },
  ...
  },
  {
    ...
    places: [
      { name: "Jerusalem (Pentecost)", short: "Jerusalem", what: "Pentecost; the first church; the apostles' base", ref: "Acts 2:1", lat: 31.781, lon: 35.231, major: true },
      { name: "Antioch (Syria)", short: "Antioch", what: "Where believers were first called \"Christians\"; Paul's sending church", ref: "Acts 11:26", lat: 36.20, lon: 36.16, major: true },
      { name: "Damascus", what: "Where Saul met the risen Christ on the road", ref: "Acts 9:3", lat: 33.51, lon: 36.30, major: true },
      { name: "Philippi", what: "First Christian convert in Europe — Lydia", ref: "Acts 16:14", lat: 41.01, lon: 24.29, major: true },
      { name: "Athens", what: "Paul on Mars Hill before the philosophers", ref: "Acts 17:22", lat: 37.98, lon: 23.73, major: true },
      { name: "Corinth", what: "Paul's eighteen-month stay; two letters survive", ref: "Acts 18:11", lat: 37.94, lon: 22.93, major: true },
      { name: "Ephesus", what: "Paul's three-year base in Asia Minor", ref: "Acts 19:10", lat: 37.95, lon: 27.37, major: true },
      { name: "Rome", what: "Paul's house arrest; the imperial capital reached", ref: "Acts 28:16", lat: 41.90, lon: 12.50, major: true },
      { name: "Patmos", what: "Where John received the Revelation of Jesus Christ", ref: "Revelation 1:9", lat: 37.32, lon: 26.55, major: true },
    ],
  },
];
