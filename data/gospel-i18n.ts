...
export type LocaleCode = "en" | "es" | "pt" | "fr" | "sw" | "hi" | "ar" | "zh";
...
آمين.`,
  ...
  zh: {
    meta: {
      pageEyebrow: "福音",
      pageTitle: "世界从未听过的最美好的好消息。",
      pageIntro:
        "只有一个福音。两千年来,来自各国、各方言、各传统的基督徒都为同一个关于耶稣的、简单而赐予生命的真理而活、而死。这就是福音——分为四个简短的部分。",
    ...
    movements: [
      {
        number: "01",
        title: "神",
        subtitle: "祂造了你。祂爱你。祂是良善的。",
        scripture:
          "起初,神创造天地……神看着一切所造的都甚好。",
        reference: "创世记 1:1, 31",
        body: "在万有之先,神就存在——圣父、圣子、圣灵——永远存在于完美的爱中。祂创造了宇宙,祂也创造了你。你是有目的地被造的,被那位良善者所造。你从来不是被造来为自己而活,或独自而活的。你是为祂而被造的。",
        echoes: ["诗篇 139:13–14", "使徒行传 17:24–28", "约翰一书 4:8"],
      },
      {
        number: "02",
        title: "我们的罪",
        subtitle: "有些东西破碎了——在这世界中,也在我们里面。",
        scripture:
          "因为世人都犯了罪,亏缺了神的荣耀……罪的工价乃是死。",
        reference: "罗马书 3:23;6:23",
        body: "从起初起,人类就选择活得好像自己是神一样,而不肯信靠祂。圣经称这是罪。这不只是坏行为——这是一段破裂的关系。罪使我们与神隔绝,破坏我们彼此之间的相交,并以死告终。我们无法靠更努力或更宗教化来修复它。我们需要被拯救。",
        echoes: ["创世记 3:1–13", "以赛亚书 59:1–2", "以弗所书 2:1–3"],
      },
      {
        number: "03",
        title: "耶稣",
        subtitle: "祂来了。祂死了。祂复活了。祂是主。",
        scripture:
          "我当日所领受又传给你们的,第一,就是基督照圣经所说,为我们的罪死了,而且埋葬了;又照圣经所说,第三天复活了,并且显给……看。",
        reference: "哥林多前书 15:3–5",
        body: "神没有把我们撇弃在罪里。神永恒的儿子成为人——拿撒勒人耶稣。祂活出了我们本该活出的生命。祂在罗马的十字架上,替我们,为我们的罪而死。祂被埋葬。第三天,祂从死里复活,胜过死亡本身。如今祂是万王之王,有一天祂还要再来。这就是那唯一的福音——没有别的福音。",
        echoes: ["约翰福音 1:14;3:16", "罗马书 5:6–8", "彼得前书 3:18"],
      },
      {
        number: "04",
        title: "你的回应",
        subtitle: "转回。信靠。跟随。归属。",
        scripture:
          "你若口里认耶稣为主,心里信神叫祂从死里复活,就必得救。",
        reference: "罗马书 10:9",
        body: "福音需要回应。从罪中转回。信靠耶稣。领受祂的圣灵。受洗。跟随祂。归属于祂的子民——教会。这不是一次性的决定;这是一生的事。它从你对祂说「是」的那一刻开始。",
        echoes: ["马可福音 1:14–15", "使徒行传 2:38–39", "约翰福音 1:12–13"],
      },
    ],
    prayer: {
      eyebrow: "一个回应的祷告",
      heading: "现在就向耶稣祷告。",
      intro:
        "如果你从未对耶稣说过「是」,或者你今天想再次说一遍,这里有一些简单的话语,你可以这样祷告。话语本身没有魔力——耶稣听的是话语背后的心。",
      body: `耶稣,
我一直为自己而活。
我犯了罪,我无法拯救自己。
我相信祢为我而死,又复活了。
...
阿们。`,
    ...
    next: {
      heading: "如果你这样祷告了——或想要这样祷告——这一周请做这四件事。",
      steps: [
        { title: "今天告诉一个人", body: "告诉一位基督徒朋友,你对耶稣说了「是」。如果你不认识任何一位,就写信给附近的一位牧者。基督徒的生命不是独自一人活的。" },
        { title: "打开圣经", body: "从约翰福音开始。我们为你预备了一个 30 天的计划。每天读一章,让耶稣亲自介绍祂自己。" },
        { title: "寻找一个本地教会", body: "洗礼、主餐,以及与神的子民同行的生命,都发生在一个真实的教会里。我们可以帮你找到一间——并认识一位真实的牧者。" },
        { title: "开始祷告", body: "像与父亲说话一样与神说话。祂就是。用主祷文作为引导。我们有一个逐句的导览,帮助你开始。" },
      ],
    },
    cta: {
      readJohn: "开始约翰福音 30 天计划",
      learnPray: "学习祷告",
      findChurch: "寻找本地教会",
    },
  },
...
export const localeOrder: LocaleCode[] = ["en", "es", "pt", "fr", "sw", "hi", "ar", "zh"];
